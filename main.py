...
def get_occurrences_from_keywords(keywords):
...
if __name__=="__main__":
    ...
    while(True):
        ...
        occurrences = get_occurrences_from_keywords(keywords)
        print(r,g,b,brightness)
        displayNewColor(r,g,b,brightness=brightness)
        display_frame(frame, occurrences, color=(r,b,g))
